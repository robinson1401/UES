...
namespace UES.Migrations
{
    ...
    [Migration("20230626083831_AddNganhTable")]
    partial class AddNganhTable
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("UES.Models.DauDiem", b =>
                {
                    ...
                    b.Property<string>("DiemQuyDoi")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("DiemToiThieuQuaMon")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
